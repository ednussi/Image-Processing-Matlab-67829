function [image] = getImage(assignmentPositionsX,assignmentPositionsY,...
                            samplingPositionsX,samplingPositionsY,weights,...
                            emptyHighResImage,renderedPyramid)
% GETIMAGE given an image of the rendered pyrmamid, sampling indices from 
% the rendered pyrmamid, and assignment indices in the highres image return 
% a high resolution image
% Arguments:
% assignmentPositionsX - (m - 4) ª (n - 4) ª 3 ª 5 ª 5 x assignment coordinates
% in the high resolution image (getSamplingInformation output)
